...
final class Version20260119130000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isPostgreSQL) {
            // PostgreSQL syntax
            $this->addSql('CREATE TABLE commande (id SERIAL NOT NULL, user_id INT NOT NULL, product_id INT DEFAULT NULL, tracking_id VARCHAR(255) NOT NULL, status VARCHAR(50) NOT NULL, amount NUMERIC(10, 2) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, UNIQUE(tracking_id), INDEX IDX_6EEAA67DA76ED395 (user_id), INDEX IDX_6EEAA67D4584665A (product_id), PRIMARY KEY(id))');
